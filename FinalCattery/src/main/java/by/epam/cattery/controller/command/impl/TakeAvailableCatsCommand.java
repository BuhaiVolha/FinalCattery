...
/**
 * The command for taking all available cats.
 *
 */
public class TakeAvailableCatsCommand implements ActionCommand {
    ...
    private static final String AVAILABLE_CATS_PAGE = ConfigurationManager.getInstance().getProperty(PathConst.AVAILABLE_CATS);
    ...
    /**
     *
     * Loads all available cats taking into account locale, counts pagination details. Puts them into {@code requestContent}.
     * Also if the role of user is {@code USER} counts price with discount.
