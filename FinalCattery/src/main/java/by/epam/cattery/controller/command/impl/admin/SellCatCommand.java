...
import by.epam.cattery.controller.command.impl.user.RenewReservationCommand;
...
public class SellCatCommand implements ActionCommand {
    private static final Logger logger = LogManager.getLogger(SellCatCommand.class);
