...
/**
 * The filter checks if the user has access to expert's pages.
 *
 */
...
public class ExpertFilter implements Filter {
    ...
    /**
     *
     * Takes user's role from session, if it's not {@code EXPERT} redirects to login page with message shown
     *
     */
