...
/**
 * The command for declining all reservations which weren't paid for when stated time (3 days) has passed.
 *
 */
public class DeclineExpiredReservationsCommand implements ActionCommand {
    ...
    /**
     * Sets all expired reservations {@code EPRD}, makes their cat available and redirects to the success page.
     *
