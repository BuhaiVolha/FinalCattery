...
public class CountColourPreferenceStatisticsCommand implements ActionCommand {
    ...
    private static final String COLOUR_STATISTICS_PAGE = ConfigurationManager.getInstance().getProperty("path.page.statistics");
    ...
    public RequestResult execute(RequestContent requestContent) throws ServiceException {
        ...
        requestContent.setAttribute("colourStatistics", statistics);
