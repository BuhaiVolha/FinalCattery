...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Таблица хранит животных для продажи';
...
INSERT INTO `cat` VALUES (1,'Apelsin','Milacoon','MALE','2018-06-13','cat1.jpg','sweet tempered and gentle','E','F64','Murka','Tom',400.00,'AVAIL',1,1,0),(2,'Alisa','Milacoon','FEMALE','2018-04-20','cat2.jpg','when she runs, she can be quite loud','W','F64','Murka','Tom',450.00,'AVAIL',1,1,0),(3,'Ben','Bright Star','MALE','2018-04-20','cat3.jpg','body is long and rectangular and the tail is also long','A','F63','Графиня','Greg',500.00,'AVAIL',1,1,0),(4,'Amelie','Milacoon','FEMALE','2018-04-20','cat4.jpg','she should be brushed to make certain that her fur does not tangle','F','F61','Murka','Tom',400.00,'AVAIL',1,1,0),(5,'Aragorn','Milacoon','MALE','2018-06-12','cat-up2169998576400098764.jpg','his origins are shrouded in mystery','F','F61','Murka','Tom',400.00,'AVAIL',1,1,0),(6,'Alpha','Milacoon','FEMALE','2018-06-14','cat6.jpg','A leader of the pack','Q','F61','Murka','Tom',450.00,'AVAIL',1,1,0),(13,'Милашка','Тигрун','MALE','2018-01-14','cat7.jpg','Издает громкие звуки','S','F63','Графиня','Кракотун',550.00,'AVAIL',3,8,0),(15,'Рыжик','Бенедикт','MALE','2018-06-05','cat8.jpg','Обладает аристократическим происхождением','F','F64','Графиня','Артур',550.00,'AVAIL',6,9,0),(17,'Барсик','Тигрун','MALE','2018-06-12','cat9.jpg','Его можно научить стоять на задних лапах','Y','F61','Графиня','Кракотун',500.00,'AVAIL',2,7,0),(41,'Марс','Милакун','MALE','2018-05-08','cat10.jpg','Мяучит в высокой тональности','E','F61','Искорка','Бенедикт',560.00,'SOLD',1,1,0),(56,'Удачка','Милакун','FEMALE','2018-05-22','cat11.jpg','Животное с которым транзакции после модификации ДАО наконец заработали','D','F63','Графиня','Кракотун',777.00,'RSRV',3,20,0),(66,'Проверочный','Горошенка','FEMALE','2018-07-10','cat13.jpg','Красивый но дерзкий','S','F61','Графиня','Кракотун',780.00,'AVAIL',1,1,0),(68,'Пятнышко','Милакун','MALE','2018-06-13','cat-up378073102890985781.jpg','Умеет выполнять примитивные трюки','A','F61','Графиня','Кракотун',600.00,'AVAIL',1,1,0),(69,'Контроллер','Милакун','MALE','2018-06-20','cat-up7643868860987636625.jpg','Умеет делать doGet и doPost','S','F62','Графиня','Кракотун',550.00,'AVAIL',1,1,0),(70,'Бублик','Бенедикт','MALE','2018-06-05','cat-up861906644820998435.jpg','Этот кот - победитель по жизни','D','F61','Песчинка','Призрак',300.00,'AVAIL',19,33,0),(71,'Мурзик','Бенедикт','MALE','2018-06-19','offer5022040088048988746.jpg','Кот проверяющий как работает addCat после апгрейда','D','F61','Песчинка','Призрак',554.00,'AVAIL',20,34,0),(72,'Китти','Белый Лев','FEMALE','2018-07-03','offer8386040540062044300.jpg','Котенок любит воду и обладает добродушным характером','D','F64','Снежинка','Томас',500.00,'AVAIL',20,44,0),(73,'Аннет','Белый Лев','FEMALE','2018-07-10','offer3702765196028177867.jpg','Хорошо смотрится на фиолетовом фоне','E','F62','Снежинка','Персиваль',400.00,'AVAIL',3,43,0);
...
CREATE TABLE `cat_colour` (
  ...
  `colour_name` varchar(45) NOT NULL COMMENT 'имя цвета',
...
CREATE TABLE `cat_eyes_colour` (
  ...
  `eyes_colour_name` varchar(15) NOT NULL,
...
INSERT INTO `cat_eyes_colour` VALUES ('F61','blue'),('F62','orange'),('F63','odd'),('F64','green');
...
INSERT INTO `user` VALUES (1,'admin','$2a$10$MhHOQ0dzEAd.1/td.9lGj.wiDwnf8m6kZbmwXPFwD2yXMFa7HP3DG','Дмитрий','Гусев','adm@mail.ru','29 0112358',NULL,2,0,0,0),(2,'cat','$2a$10$MhHOQ0dzEAd.1/td.9lGj.wiDwnf8m6kZbmwXPFwD2yXMFa7HP3DG','Mike','Atter','mike@mail.ru','29 3141592','F',1,10,0,0),(3,'koko','$2a$10$kThb.Euqqk6UzBhztUKoNuGcE1FHyyoTGuFS4GX6g4AL38pi/QdOm','Анна','Кристева','kristeva@yandex.com','29 6545344','W',1,5,0,1),(4,'catlover','$2a$10$MhHOQ0dzEAd.1/td.9lGj.wiDwnf8m6kZbmwXPFwD2yXMFa7HP3DG','Виолетта','Рожденственская','vvvv@mail.ru','25 1228033','Y',1,0,0,1),(5,'expert','$2a$10$MhHOQ0dzEAd.1/td.9lGj.wiDwnf8m6kZbmwXPFwD2yXMFa7HP3DG','Светлана','Люлькович','sams@mail.ru','29 1688033',NULL,3,0,0,0),(6,'мур','$2a$10$MhHOQ0dzEAd.1/td.9lGj.wiDwnf8m6kZbmwXPFwD2yXMFa7HP3DG','Ада','Турова','kittens@gmail.ru','25 1619333','D',1,10,0,1),(7,'dog','$2a$10$MhHOQ0dzEAd.1/td.9lGj.wiDwnf8m6kZbmwXPFwD2yXMFa7HP3DG','Jake','Juke','or55h@yandex.com','29 1618133','W',1,0,0,0),(8,'ofa','$2a$10$MhHOQ0dzEAd.1/td.9lGj.wiDwnf8m6kZbmwXPFwD2yXMFa7HP3DG','Вера','Кошкина','vera@mail.ru','25 1888033',NULL,1,0,0,0),(10,'sima','$2a$10$9rynM1KLW2RZi8m1AWIg4uepugmTIxWBNvgHUsQCtbkNErZHQ4qSS','Simba','KorolLev','kira-smi@mail.ru','29 1619133','D',1,0,0,0),(11,'barsuk','$2a$10$/7/ZhFPKvq6Ov4rat2rhx.k.wuKshbFaH2kg24vSpHnPx04oVt9wa','Barsuk','Barsu4ij','ki@mail.ru','25 1418033','D',1,0,1,0),(12,'kotkot','$2a$10$jb8W38UoGrk8FxCOiaJd9egetYjG7JnAVoS9HEvgvlVwqqgWGOiQG','kolya','checkov','kir6mi@mail.ru','29 1619033','N',1,0,0,0),(13,'kroshka','$2a$10$bciwj/j0knZhhHcP1a8nFerBIEYXlqq90cB1KY1CexJbF.lzQl3H6','Duke','Horington','kir5555gami@mail.ru','29 1668033','A',1,0,1,0),(14,'grusha','$2a$10$Bt/bo.v4Y1kx3Lo0SToxR.M5ptek5dRhcmZE2xHZwqdqT/aJRZyPa','Boris','Petrovich','ki77ami@mail.ru','33 7978033',NULL,1,0,0,0),(15,'geraldina','$2a$10$4E8GrIQlQwN/Ox9SyWBp2u0iCbL2rAFd6hXOpxJ8kuOTLBBIubWwO','Анна','Как-нибудь','kira-980444mi@mail.ru','29 5558033','E',1,0,0,0),(16,'pupsik','$2a$10$ISSFNr.eo8ayOx7.nkbmSOWsL5Gjs0nJZMOmC1jvECnt7zmVhZVDS','Simba','Rassmeshi','simba@mail.ru','29 1690033','D',1,0,0,0),(18,'Mary-Ann','$2a$10$1p7zAokebfpMGdc.RzVgX.gnbWbAJT3q3zNA9mdvYunxmncNy73qS','Мария','Коржикова','korzhik@yandex.by','29 5618033',NULL,1,0,0,0),(19,'King','$2a$10$zXLPAdkBq6NPqRT1wM.mpeotSBmbyObW0ljkI/ITkrlHGjh4Vyjha','Собачий','Король','kingking23@mail.ru','44 8958586',NULL,1,0,0,0),(20,'CatsNice','$2a$10$ItHPLtCI8Lwp9a2G6464quyoaSU2ZdOO/a7O9CKsesK0rCQPZzhGO','Говард','Котов','goward-kotov11@mail.ru','33 1618033','Y',1,0,0,1),(21,'Lapka','$2a$10$LCzETKCdAB0qnc7PQ.R6UuMPqABCbFs1mUsJXAIsnMps.lEWmAjsK','Витя','Терлецкий','vitka@yandex.by','33 1618033','F',1,5,0,1),(22,'Lancelap','$2a$10$YF/P21Sq4VbKNWT5kDwXwOcYr5imhDWJ3tGk0MG9UgGlqiwsjYGi.','Ланс','Лап','lancelap@gmail.com','29 8918013','N',1,0,0,0),(23,'RedCat','$2a$10$KgB.iawfjherzlHmqxKqQ.0os/gvIUaY7e1HidwQPjAazXxTpzGKG','Иван','Мельников','vanyaM@yandex.ru','29 1618033','D',1,0,0,0),(24,'Nameless','$2a$10$q2EQ2qObdDxqbStu/s5QkeNC43PC7OZZuvpxB2aHBDlyKJI6JBOdq','Иван','Иванов','torment-pl@mail.ru','29 1617433',NULL,1,0,0,0),(25,'котяра','$2a$10$54O6ZkUMYqMVPNliTD4krODfs6WZbV8d66j9K6gSZe3RWrzQUGwl2','Ян','Хвалей','hvaley@mail.ru','29 2455429','N',1,5,0,0),(30,'double','$2a$10$jWF9fn0FECpoYw.xC8Lw8.MoHcQe8Q9iev3nYoncpwavD5/zsT/oi','Дабла','Крекер','double@gmail.com','29 6323321',NULL,1,0,0,1),(31,'robthemob','$2a$10$cxxUPLsISiGrjq1kv6cX3.gxpwgFvmQuieTZDyAJSwPkH9ceq/bam','Вика','Третьякова','vika-tretyak@gmail.com','29 7362637',NULL,1,0,0,1),(32,'papuga','$2a$10$EyD2C41QlOvkOzhyfALn3.fvm7CXcPe2X/fkrq6gXcaIbnaIGW/9q','Василий','Торкин','papuga-guga@mail.ru','29 7636232','Q',1,0,0,1),(33,'superman','$2a$10$SWzyFFA1du5gvs8zN/yeWeT5lDkbI0ZpZpBJKRIWdpg3C5ckapuKK','Кларк','Кент','superman@yandex.by','29 8347372','S',1,0,0,0);
...
INSERT INTO `user_offer` VALUES (1,1,'Котенок питомника, добавленный админом',NULL,0.00,'SENT',NULL,NULL,0),(2,3,'Этот котенок очень любит мясо и молоко','offer4735497484986632260.jpg',420.00,'AWAIT',NULL,NULL,0),(3,25,'Черно-белый котяра. Белый медальон и галстук  в придачу к белым носочкам!','offer1956987230810080526.jpg',500.00,'AWAIT',NULL,NULL,0),(4,6,'Я нашла этого котенка  за несколько недель до смерти','offer8788522280027144517.jpg',700.00,'AWAIT',NULL,NULL,0),(5,22,'Все характеристики соответствуют породе. Есть документы.',NULL,550.00,'DISC','Мы заинтересованы в приобретении вашего котенка, но в связи с присутствующими дефектами (лапы недостаточно большие), предлагаем вам следующую цену.',NULL,0),(6,6,'Котенок премиум-класса, рожденный от победителей выставки \"Кот Мира 2008\"','offer8680588950082093292.jpg',1000.00,'AWAIT',NULL,NULL,0),(7,2,'Очень красивый, ласковый котенок, приучен к лотку, красивая блестящая шерсть. Любит купаться.',NULL,300.00,'SENT',NULL,'Очень дешево, надо брать!',0),(8,3,'Котенок умеет выполнять трюки. Пьет воду с помощью лап',NULL,500.00,'DISC','Как насчет 500? У вашего кота слишком короткий хвост!',NULL,0),(9,6,'Просто купите его пожалуйста',NULL,500.00,'SENT',NULL,'Красивые уши',0),(10,22,'Самый крутой кот на свете, отвечаю!!! ',NULL,300.00,'DISC','400 и по рукам?',NULL,0),(11,6,'Предлагаю так дешево, потому что у котенка небольшой недобор массы','offer2189223048871110737.jpg',250.00,'APRVD',NULL,'Не указывать про недобор массы',0),(16,3,'Маленький горячий пирожок',NULL,79.00,'REJCT','не не не не',NULL,0),(20,3,'Кот на вес золота',NULL,700.00,'SENT',NULL,'Кот похож на драгоценность',0),(29,31,'Проверка что все срабоьет','offer4618052843810997040.jpg',777.00,'AWAIT',NULL,NULL,1),(31,31,'Проверка статуса','offer3938942526609147375.jpg',666.00,'DISC','кеукеуке',NULL,1),(32,3,'Ghjkjkj','offer3852711772001766026.jpg',123.00,'DISC','выаол',NULL,1),(33,19,'Этот кот победитель по жизни','offer1950840749877753403.jpg',300.00,'SENT',NULL,'Отредактировать фотографию',0),(34,20,'Кот проверяющий загрузку картинок ','offer5022040088048988746.jpg',554.00,'SENT',NULL,'Кот проверяющий загрузку картинок',0),(35,3,'Прекрасный кот, который проверит мне работает ли все как надо сейчас','offer5246146400902396934.jpg',300.00,'DISC','У нас очень много котят этого окраса и как показывает статистика он не очень популярен сейчас',NULL,0),(36,20,'Просто посмотрите на фотографию','offer563742148779508640.jpg',350.00,'AWAIT',NULL,NULL,0),(43,3,'вапвапвап','offer3702765196028177867.jpg',400.00,'SENT',NULL,'Да как-то тут и нечего сказать',0),(44,20,'Кот проверяющий что все работает после обновы комманд','offer8386040540062044300.jpg',500.00,'SENT',NULL,NULL,0),(45,3,'dfsfsd','offer7540283564693479432.jpg',545.00,'AWAIT',NULL,NULL,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Эта таблица представляет собой заказ пользователя';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Отзыв, который пользователь может оставить о питомнике';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-12  1:19:33
